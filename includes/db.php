...
function get_pdo(): PDO
{
    ...
    try {
        ...
        echo '<p>MK Intranet praat met dezelfde database als het meldkamersysteem. Controleer de instellingen '
           . 'in <code>config.php</code> / je <code>docker-compose.yml</code> (host, gebruikersnaam, wachtwoord, '
           . 'databasenaam) en zorg dat dit netwerk de databasecontainer van het meldkamersysteem kan bereiken.</p>';
